...
-- 1. Desativa temporariamente o Modo Seguro e checagem de chaves estrangeiras
SET SQL_SAFE_UPDATES = 0;
SET FOREIGN_KEY_CHECKS = 0;

-- 2. Limpa os dados antigos e reseta o ID
...
-- Insere os dados mapeando as colunas
...
-- 4. Consolida as inserções
COMMIT;

-- 5. Restaura as travas de segurança
SET FOREIGN_KEY_CHECKS = 1;
SET SQL_SAFE_UPDATES = 1;

-- 6. Consulta para validar
